...
- Calls to `setup_logging()` outside the four wired entry points: [annotator/__main__.py](../../../annotator/__main__.py), [annotator/run.py](../../../annotator/run.py) `main()`, [benchmark/__main__.py](../../../benchmark/__main__.py), [benchmark/run.py](../../../benchmark/run.py) `main()`. Library code must not configure logging.
