...
**Open follow-ups:**
- Zero cross-reviewer overlap means no human inter-rater ceiling. A small side exercise (2-3 reviewers rating 30-50 shared items) would establish one.
- Nathan contributed 60% of the data. Worth checking distribution drift before scaling further.
