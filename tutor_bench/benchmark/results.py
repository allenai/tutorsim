"""Run-results store for benchmark runs.
...
def read_config(run_id: str, results_root: str = "results") -> dict | None:
...
def read_summary(run_id: str, results_root: str = "results") -> dict | None:
