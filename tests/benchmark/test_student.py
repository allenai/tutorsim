...
class TestGetOrGenerateTrait:
    ...
    def test_cache_miss_calls_generate_and_writes_cache(self, tmp_path):
        ...
        from tutor_bench.benchmark.student import get_or_generate_trait
...
class TestBuildStudentSystemPrompt:
    ...
    def test_substitutes_reference_transcript(self):
        ...
        from tutor_bench.benchmark.student import build_student_system_prompt
...
class TestResolveStudent:
    ...
    def test_resolve_student_registered(self, monkeypatch):
        ...
        from tutor_bench.benchmark.config import _STUDENT_REGISTRY, register_student
    ...
    def test_resolve_student_registered_from_config_model(self, tmp_path, monkeypatch):
        ...
        from tutor_bench.benchmark.config import (
            _STUDENT_REGISTRY,
            _reset_config_cache,
            register_student,
        )
...
""",
        ...
        monkeypatch.setenv("TUTOR_BENCH_CONFIG", str(config_path))
        _reset_config_cache()
