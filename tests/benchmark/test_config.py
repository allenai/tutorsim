from tutor_bench.benchmark import config as cfgmod
...
def test_load_config_returns_parsed_dict():
    ...
    assert cfgmod.describe_config_source() == "tutor-bench:default_config.yaml"
...
def test_register_and_lookup_tutor():
    from tutor_bench.benchmark import register_tutor
...
def test_register_and_lookup_student():
    from tutor_bench.benchmark import register_student
