...
Train/test split of the 207 conversations in `ground_truth_v2/`, assigned by conversation ID (seed=42). Generated by `split_ground_truth.py`.

### Train (103 conversations, 3,252 moments)

| | scaffolding (700) | rapport (2,552) |
|---|---|---|
| effective | 228 (32.6%) | 1,312 (51.4%) |
| partial | 147 (21.0%) | 608 (23.8%) |
| ineffective | 325 (46.4%) | 632 (24.8%) |

Moments with IOU ≥ 0.3 across >1 annotator: 2,845 (87.5%)

### Test (104 conversations, 3,207 moments)

| | scaffolding (912) | rapport (2,295) |
|---|---|---|
| effective | 335 (36.7%) | 1,196 (52.1%) |
| partial | 202 (22.1%) | 533 (23.2%) |
| ineffective | 375 (41.1%) | 566 (24.7%) |

Moments with IOU ≥ 0.3 across >1 annotator: 2,704 (84.3%)
